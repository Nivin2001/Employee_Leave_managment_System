...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->routeIs('departments.*') ? 'active' : '' }}" data-toggle="collapse"
            href="#collapsedepartments" aria-expanded="false" aria-controls="collapseDepartments">
            <i class="fa-solid fa-user-group"></i>
            <span>Department Section</span>
        </a>
        <div id="collapsedepartments" class="collapse {{ request()->routeIs('departments.*') ? 'show' : '' }}"
            aria-labelledby="headingEmployees" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ request()->routeIs('departments.create') ? 'active' : '' }}"
                    href="{{ route('departments.create') }}">Add New</a>
                <a class="collapse-item {{ request()->routeIs('departments.index') ? 'active' : '' }}"
                    href="{{ route('departments.index') }}">All Departments</a>
            </div>
        </div>
    </li>
...
<li class="nav-item">
    ...
    <div id="collapseLeaveBalance" class="collapse" aria-labelledby="headingLeaveBalance"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item {{ request()->routeIs('leave-balance.create') ? 'active' : '' }}"
                href="{{ route('leave-balance.create') }}">Add Balance</a>
            <a class="collapse-item {{ request()->routeIs('leave-balance.index') ? 'active' : '' }}"
                href="{{ route('leave-balance.index') }}">View Balances</a>
        </div>
    </div>
</li>
<hr class="sidebar-divider">
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="leaveDropdown">
        <a class="dropdown-item" href="{{ route('admin.leave-requests.index', ['status' => 'pending']) }}">
            <i class="fas fa-clock"></i> Pending
        </a>
        <a class="dropdown-item" href="{{ route('admin.leave-requests.index', ['status' => 'approved']) }}">
            <i class="fas fa-check-circle"></i> Approved
        </a>
        <a class="dropdown-item" href="{{ route('admin.leave-requests.index', ['status' => 'rejected']) }}">
            <i class="fas fa-times-circle"></i> Declined
        </a>
        <a class="dropdown-item" href="{{ route('admin.leave-requests.index') }}">
...
<hr class="sidebar-divider">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->is('admin/admins') ? 'active' : '' }}" href="{{ route('admin.admins') }}">
            <i class="fa-solid fa-user-group"></i>
    ...
    <hr class="sidebar-divider">
    <li class="nav-item">
        <a class="nav-link" href="{{ route('reports.leave-requests') }}">
