<?php $__env->startSection('title', 'Add Employees'); ?>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" placeholder="Name">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" placeholder="Your email" >
...
unset($__errorArgs, $__bag); ?>" id="dob" name="dob" placeholder="Date of Birth">
            <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" id="city" name="city" placeholder="City">
...
unset($__errorArgs, $__bag); ?>" id="contact" name="contact" placeholder="Contact Number">
...
unset($__errorArgs, $__bag); ?>" id="department_id" name="department_id">
...
<?php echo $__env->make('LEMS.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp - Copy\htdocs\ELMS-main\resources\views/LEMS/admin/employee/create.blade.php ENDPATH**/ ?>